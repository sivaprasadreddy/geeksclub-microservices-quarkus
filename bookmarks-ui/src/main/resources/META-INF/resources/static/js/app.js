new Vue({
  ...
  methods: {
    loadBookmarks() {
      let self = this;
      $.getJSON(bookmarksApiBaseUrl+"/api/v1/bookmarks", function (data) {
        self.bookmarks = data
        self.error = null;
      }).fail(function (err){
    ...
    saveBookmark() {
      ...
      $.ajax({
        type: "POST",
        url: bookmarksApiBaseUrl+'/api/v1/bookmarks',
    ...
    upvoteBookmark(bookmarkId) {
      ...
      $.ajax({
        type: "PUT",
        url: votesApiBaseUrl+'/api/v1/bookmarks/' + bookmarkId + '/votes/up',
        contentType: "application/json",
        success: function () {
          self.error = null;
          self.loadBookmarks();
    ...
    downvoteBookmark(bookmarkId) {
      ...
      $.ajax({
        type: "PUT",
        url: votesApiBaseUrl+'/api/v1/bookmarks/' + bookmarkId + '/votes/down',
        contentType: "application/json",
        success: function () {
          self.error = null;
          self.loadBookmarks();
